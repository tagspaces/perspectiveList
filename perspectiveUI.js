...
define(function(require, exports, module) {
      ...
      "aoColumns": [
        {
          ...
          "mRender": function(data, type, row) {
            return self.buttonizeTitle(row.title, row.path, row.extension);
          },
          "mData": "extension",
        }, {
          "sTitle": "Title",
  ...
  var buttonCompTmpl = Handlebars.compile('<button filepath="{{filepath}}" class="btn btn-link fileSelection"><i class="fa {{selected}} fa-fw fa-lg"></i></button><br>' +
    '<button filepath="{{filepath}}" title="{{filepath}}" class="btn btn-link fileTitleButton fileExtColor" data-ext="{{fileext}}"><span class="fileExt">{{fileext}}&nbsp;&nbsp;<span class="fa fa-ellipsis-v"></span></span></button>');
